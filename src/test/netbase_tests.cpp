...
{
    BOOST_CHECK(TestSplitHost("www.foocoin.net", "www.foocoin.net", -1));
    BOOST_CHECK(TestSplitHost("[www.foocoin.net]", "www.foocoin.net", -1));
    BOOST_CHECK(TestSplitHost("www.foocoin.net:80", "www.foocoin.net", 80));
    BOOST_CHECK(TestSplitHost("[www.foocoin.net]:80", "www.foocoin.net", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19966", "127.0.0.1", 19966));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19966", "127.0.0.1", 19966));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19966", "::ffff:127.0.0.1", 19966));
    BOOST_CHECK(TestSplitHost("[::]:19966", "::", 19966));
    BOOST_CHECK(TestSplitHost("::19966", "::19966", -1));
    BOOST_CHECK(TestSplitHost(":19966", "", 19966));
    BOOST_CHECK(TestSplitHost("[]:19966", "", 19966));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19966", "127.0.0.1:19966"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19966", "[::]:19966"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
